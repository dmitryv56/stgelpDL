...
"""
     ...
     chmod +x start_dtwcanbus.py

     ./start_dtwcanbus.py -m debug -M DTWIN -S 64 -s 32 -d "/home/dmitryv/ICSim/ICSim/candump-2021-02-23_143436.log"
     -f 16 -b 256 -R 60 -p 0.3 -c 32 --BFsize 2048 --BFprob 0.05 -z 64 -e 16 -t "CanBus_FD_dbg"

     or

     ./start_dtwcanbus.py --mode debug --method DTWIN --train_size 64 --test_size 32

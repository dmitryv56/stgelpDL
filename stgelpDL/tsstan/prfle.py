...
from tsstan.pltStan import setPlot
...
def crtDictProfile(df: pd.DataFrame, dt_col_name: str, data_col_name: str, typeProfile: str = 'day',
                   f: object = None) -> dict:
    d_data = {}
...
def kMeanCluster(name: str, X: np.array, labelX: list, file_png_path: str, f: object = None) -> (
dict, dict, dict, dict):
    pass
    n_cluster_max = 10
    n_pc = 2
